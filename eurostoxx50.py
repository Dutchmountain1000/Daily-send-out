...
<style>
  ...
  h2 {{ color: #003366; font-size: 16px; }}
  h3 {{ color: #004080; font-size: 14px; margin-top: 20px; }}
  table {{ border-collapse: collapse; width: 100%; margin-top: 8px; margin-bottom: 15px; font-size: 12px; }}
...
<h3>Major European Equity Indices</h3>
{df_indices.to_html(index=False)}
<h3>Euro Stoxx 50 YTD Trend</h3>
<p><img src="cid:ytd_chart" alt="Euro Stoxx 50 YTD Chart" style="width:100%;max-width:600px;height:auto;display:block;"></p>
<h3>Top 10 Gainers (Euro Stoxx 50 Stocks - 1D)</h3>
{top_10_gainers.to_html(index=False)}
<h3>Top 10 Losers (Euro Stoxx 50 Stocks - 1D)</h3>
{top_10_losers.to_html(index=False)}
<p style="font-size: 11px; font-style: italic; color: #666; margin-top: 25px;">Generated by Peter van Vliet.</p>
</body>
</html>"""
