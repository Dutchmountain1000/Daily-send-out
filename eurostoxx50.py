...
indices = {
	"Euro Stoxx 50": "^STOXX50E", "DAX (Germany)": "^GDAXI",
	"CAC 40 (France)": "^FCHI", "FTSE 100 (UK)": "^FTSE",
	"SMI (Switzerland)": "^SSMI", "AEX (Netherlands)": "^AEX",
	"IBEX 35 (Spain)": "^IBEX", "FTSE MIB (Italy)": "FTSEMIB.MI",
}
